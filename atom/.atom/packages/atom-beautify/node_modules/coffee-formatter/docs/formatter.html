...
<p>Two-space operators.  These operators should have one space both before and after.</p>
          ...
          <div class='highlight'><pre>TWO_SPACE_OPERATORS = [<span class="hljs-string">'?='</span>, <span class="hljs-string">'='</span>, <span class="hljs-string">'+='</span>, <span class="hljs-string">'-='</span>, <span class="hljs-string">'=='</span>, <span class="hljs-string">'&lt;='</span>, <span class="hljs-string">'&gt;='</span>,
                    <span class="hljs-string">'&gt;'</span>, <span class="hljs-string">'&lt;'</span>, <span class="hljs-string">'+'</span>, <span class="hljs-string">'-'</span>, <span class="hljs-string">'*'</span>, <span class="hljs-string">'/'</span>]</pre></div>
