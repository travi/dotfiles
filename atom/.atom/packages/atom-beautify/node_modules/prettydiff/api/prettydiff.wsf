        ...
        <script type="text/javascript" src="../prettydiff-min.js">
            ...
            (function () {
                ...
                var args = {},
                    ...
                    outerror = function (x) {
                        ...
                        if (WScript.Arguments.Count() === 0 || help === true) {
                            ...
                            error.push("");
                            error.push("* objsort      - string  - Sorts properties by key name in JavaScript and/or CSS. Defaults to 'none', which turns off sorting.");
                            ...
                            error.push("");
                            error.push("* vertical     - string  - If lists of assignments and properties should be vertically aligned. Default is 'none'.");
                            error.push("                 Accepted values: all, css, js, none");
                            error.push("");
                            error.push("* wrap         - string  - The number of characters text content in a markup document or a string in JavaScript is allowed before wrapping onto a new line.  Default is 0 which disables text wrapping and a value of -1 will concatenating strings separated by a '+' operator.");
                            error.push("");
                ...
                if (fail === false) {
                    ...
                    args.vertical = (WScript.Arguments.Named("vertical") === "all" || WScript.Arguments.Named("vertical") === "css" || WScript.Arguments.Named("vertical") === "js") ? WScript.Arguments.Named("vertical") : "none";
