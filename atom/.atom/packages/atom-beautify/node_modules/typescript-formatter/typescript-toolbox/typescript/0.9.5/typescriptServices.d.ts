...
declare module TypeScript {
    ...
    class PullSignatureSymbol extends PullSymbol implements InstantiableSymbol {
        ...
        public forCorrespondingParameterTypesInThisAndOtherSignature(otherSignature: PullSignatureSymbol, callBack: (thisSignatureParameterType: PullTypeSymbol, otherSignatureParameterType: PullTypeSymbol) => void): void;
...
declare module TypeScript {
    ...
    class PullTypeResolutionContext {
        ...
        public getGenerativeClassifications(): {
            generativeClassification1: TypeScript.GenerativeTypeClassification;
            generativeClassification2: TypeScript.GenerativeTypeClassification;
        };
...
declare module TypeScript {
    class PullSymbolBinder {
        ...
        private bindOtherDecls(currentlyBindingDecl, searchGlobally);
